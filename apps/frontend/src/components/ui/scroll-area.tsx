...
>(({ className, orientation = "vertical", ...props }, ref) => {
  ...
  return (
    <ScrollAreaPrimitive.ScrollAreaScrollbar
      ...
      className={cn(
        "hover:bg-background dark:hover:bg-muted/50 data-[state=visible]:fade-in-0 data-[state=hidden]:fade-out-0 data-[state=visible]:animate-in data-[state=hidden]:animate-out flex touch-none p-px transition-[colors] duration-150 select-none",
        orientation === "vertical" &&
          "h-full w-2.5 border-l border-l-transparent",
        orientation === "horizontal" &&
          "h-2.5 flex-col border-t border-t-transparent px-1 pr-1.25 z-[9999]",
        className
      )}
      {...props}
    >
  ...
  return (
    <>
      ...
      <div
        ...
        style={
          {
            "--left-fade-width": showMask.left ? "20px" : "0px",
            "--right-fade-width": showMask.right ? "20px" : "0px",
          } as React.CSSProperties
        }
        className={cn(
          "pointer-events-none absolute inset-0 z-10",
      ...
      {/* GradualBlur overlays for enhanced blur effect */}
      {showMask.left && (
