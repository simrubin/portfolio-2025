...
export const ImageZoom = ({
  ...
  >
    <Zoom
      classDialog={cn(
        "[&::backdrop]:hidden",
        "[&[open]]:fixed [&[open]]:m-0 [&[open]]:h-screen [&[open]]:max-h-none [&[open]]:w-full [&[open]]:max-w-none [&[open]]:overflow-hidden [&[open]]:border-0 [&[open]]:bg-transparent [&[open]]:p-0",
        "[&_[data-rmiz-modal-overlay]]:fixed [&_[data-rmiz-modal-overlay]]:inset-0 [&_[data-rmiz-modal-overlay]]:h-full [&_[data-rmiz-modal-overlay]]:w-full [&_[data-rmiz-modal-overlay]]:transition-all [&_[data-rmiz-modal-overlay]]:ease-in-out [&_[data-rmiz-modal-overlay]]:duration-300",
