...
export interface Project {
  ...
  title: string;
  /**
   * URL-friendly version of the title (e.g., "matilda-demo")
   */
  slug: string;
  /**
   * Main image shown on the homepage and at the top of the project page
   */
  ...
  publishedAt: string;
  /**
   * Year of the project (for display purposes)
   */
  year: number;
  newlyAdded?: boolean | null;
  sections?:
    | {
        sectionTitle: string;
        textBody: {
