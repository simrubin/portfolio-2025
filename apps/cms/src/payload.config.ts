...
import { ProjectSimple } from './collections/ProjectSimple'
...
const databaseAdapter = process.env.POSTGRES_URL
  ? vercelPostgresAdapter({
      ...
      push: true, // Auto-create schema on first run
...
export default buildConfig({
  ...
  db: databaseAdapter,
  collections: [Pages, Posts, Media, Categories, Users, Project, ProjectSimple],
